...
\begin{flalign}
& J_i \geq j \Rightarrow S_i \geq dayBegin_j, & \forall i \in \T, \forall j \in \mathbb{J} \\
& J_i \leq j \Rightarrow S_i \leq dayEnd_j, & \forall i \in \T, \forall j \in \mathbb{J}
\end{flalign}

%Rendu à embarquer sur le modèle préemptif
